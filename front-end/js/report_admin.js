import { listarTodosFormularios } from './api.js';
...
function renderizarLista() {
  ...
  formularios.forEach(f => {
    ...
    meta.textContent = `${data ? `Data: ${data}` : 'Sem data'} | Profissional: ${f.nome_usuario || 'N/A'}`;
    ...
    details.href = `report_detail_admin.html?id=${id}`;
